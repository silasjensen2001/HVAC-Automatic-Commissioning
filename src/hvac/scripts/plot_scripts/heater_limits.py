...
ax.set_title("Heater — Average Air Temperature by Valve Position", fontsize=13)
ax.legend(fontsize=9, ncol=2, loc="upper right", framealpha=1.0)
ax.grid(True, alpha=0.35)
ax.set_xlim(0, t_end)


plt.tight_layout()
plt.savefig("heater_valve_comparison.png", dpi=300, bbox_inches='tight')
plt.show()